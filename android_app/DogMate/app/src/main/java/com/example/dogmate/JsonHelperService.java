...
//    }
    ...
    public static JSONObject createRegistrationRequest(String firstName, String lastName, String userName, String password, String emailAddress, int numberOfDogs, String relativeImageUrl){
        JSONObject returnJson = new JSONObject();
